...
def lv():
    ...
    os.system('tput setaf 6')
    x=sp.getstatusoutput('lvcreate --size {0}G --name {1} {2}'.format(lsize,pnam                                                                             e,vname))
    if x[0]==0:
...
def menu():
    while True:
         ...
         os.system('tput setaf 1')
         print()
         print("\t\t\t\tLVM PARTITION AUTOMATION PROGRAM ")
         print("\t\t\t\t---------------------------------")
         print()
         os.system('tput setaf 2')
         print("\t\t\t\t    1.List all Attached Disk")
         print("\t\t\t\t    2.List all Physical Volume")
         print("\t\t\t\t    3.List all Volume Group")
         print("\t\t\t\t    4.List all Logical Volume")
         print("\t\t\t\t    5.Create Physical Volume")
         print("\t\t\t\t    6.Create Volume Group")
         print("\t\t\t\t    7.Create Logical Volume")
         print("\t\t\t\t    8.Extend volume")
         print("\t\t\t\t    9.Exit")
         print()
         os.system('tput setaf 3')
